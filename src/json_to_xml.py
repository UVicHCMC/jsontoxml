...
class Actor:
    def __init__(self, id: Optional[int], pseudonym: Optional[str], pseudonym_number: Optional[int],
                 honorific: Optional[str],
                 first_name: Optional[str], last_name: Optional[str], alias: Optional[str], status: Optional[str],
                 entree: Optional[int],
                 societariat: Optional[int], depart: Optional[int], debut: Optional[list[int]],
